...
class BCNN(torch.nn.Module):
    ...
    def freeze_layers(self):
        ...
        for param in self._conv1.parameters():
            param.requires_grad = False
        for param in self._bn1.parameters():
            param.requires_grad = False
        ...
        for param in self._layer3.parameters():
            param.requires_grad = False
        for param in self._layer4.parameters():
            param.requires_grad = False
...
def fc():
    ...
    pre_model_path = None
    path_save='models/resnet34_fc_double_224.pth'
...
def all_layers():
    ...
    pre_model_path = 'models/resnet34_fc_double_224.pth'
    path_save='models/resnet34_all_double_224.pth'
