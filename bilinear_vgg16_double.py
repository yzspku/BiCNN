...
class BCNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        [:-1])  # Remove pool5.
        self._features = torchvision.models.vgg16(pretrained=True).features
        self._features = torch.nn.Sequential(*list(self._features.children())
        [:-1])  # Remove pool5.
        # Linear classifier.
...
def fc():
    ...
    pre_model_path = None
    path_save='models/vgg16_fc_double.pth'
...
def all_layers():
    ...
    pre_model_path = 'models/vgg16_fc_double.pth'
    path_save='models/vgg16_all_double.pth'
